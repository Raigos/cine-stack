...
import { EmptyStateContainer, EmptyStateTitle, EmptyStateMessage, EmptyStateHint } from './styles/EmptyStateStyles'
...
export const EmptyState = (): React.ReactElement => {
  ...
  return (
    <EmptyStateContainer>
      <EmptyStateTitle variant="h2">Movie not found!</EmptyStateTitle>
      <EmptyStateMessage variant="h6">{message}</EmptyStateMessage>
      <EmptyStateHint variant="body1">Try adjusting your search terms</EmptyStateHint>
    </EmptyStateContainer>
  )
}
